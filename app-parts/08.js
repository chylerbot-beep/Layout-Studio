      ...
      $('autoFitBasemap').onclick=autoFitBasemap;$('ocrDimensions').onclick=readDimensionsWithOcr;$('applyOcrDimensions').onclick=applyOcrDimensions;$('resetBasemapCrop').onclick=()=>{if(!project.basemap)return;pushHistory('reset basemap crop');project.basemap.crop={left:0,top:0,right:1,bottom:1};wallDetectionCache=null;buildBasemap(true);$('basemapStatus').textContent='Crop reset to the full uploaded image.';};
